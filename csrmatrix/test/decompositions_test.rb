...
class DecompositionsTest < Minitest::Test
  ...
  def test_eigen
	...
	def test_lup
    assert_equal [[[1, 0, 0], [3, 1, 0], [2, 1, 1]], [[1, 2, 4], [0, 2, 2], [0, 0, 3]]], @matrixSparse3x3.lup()
  end

	def test_lup_decomposition
    assert_equal [[[1, 0, 0], [3, 1, 0], [2, 1, 1]], [[1, 2, 4], [0, 2, 2], [0, 0, 3]]], @matrixSparse3x3.lup_decomposition()
  end
